...
#웹페이지 초기세팅
sendphoto(osphoto = "db 사용자 사진 저장 경로", path='/home/masgt/Desktop/main', file="face8.jpg")
...
dataUpdate(table1= 'userManagement', colom1='SL', data1='2', colom2 = 'user_name', data2='1001')
...
def kakao(txt):
    ...
    friend_id = friends_list[1].get("uuid") #친구를 여러명 등록했으면 리스트중 보낼 1인만 넣으면 됨
...
def periodic_task():
    ...
    while True:
        ...
        if datarecv(colom1='tp', table1='userManagement', colom2='user_name', data1=("1001",)) == str(1):
            exec(open("./sub/face.py").read())
            
            sendphoto(osphoto = "db의 사용자 사진 저장 경로", path=PATH, file="face8.jpg")
            dataUpdate(table1= 'userManagement', colom1='tp', data1='0', colom2 = 'user_name', data2='1001')
            lcdkey = 1
        time.sleep(1)
...
while True:
    ...
    if count == -1:
        ...
        reference_image_file1 = "./sub/face8.jpg"
        reference_image_file2 = "./sub/manager.jpg"
    ...
    if count == 3:
        ...
        sendphoto(osphoto = "db 침입자 사진 저장 경로", path=PATH, file=filename)
        kakao("비밀번호 3회 오류")
        count = 4
